...
Status: implementation tracker. Updated through the fifth compact-admission
...
- Step 8's first five inactive foundations add the canonical writer and review
  table model, complete model validation and rendering, digest helper, and
  empty and representative golden vectors without changing active format-1
  admission.
...
Next step: **add the strict compact-state model, parser, and writer**.
