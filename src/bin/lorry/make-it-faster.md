...
Status: implementation tracker. Updated through the sixth compact-admission
...
- Step 8's first six inactive foundations add the canonical writer and review
  ...
  validation, without changing active format-1 admission.
...
Next step: **add the strict compact-state parser and writer**.
