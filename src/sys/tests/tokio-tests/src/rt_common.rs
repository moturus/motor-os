...
rt_test! {
    ...
    fn test_block_on_sync() {
        ...
        assert!(win);
        println!("\t{}/test_block_on_sync PASS", module_path!());
    }
    ...
    fn test_block_on_async() {
        ...
        assert_eq!(out, "ZOMG");
        println!("\t{}/test_block_on_async PASS", module_path!());
    }

    fn test_spawn_one_bg() {
        let rt = rt();
        ...
        assert_eq!(out, "ZOMG");
        println!("\t{}/test_spawn_one_bg PASS", module_path!());
    }

    fn test_spawn_one_join() {
        let rt = rt();
        ...
        assert_eq!(out, "ZOMG");
        println!("\t{}/test_spawn_one_join PASS", module_path!());
    }
    ...
    fn test_spawn_two() {
        ...
        assert_eq!(out, "ZOMG");
        println!("\t{}/test_spawn_two PASS", module_path!());
    }

    #[cfg(not(target_os="wasi"))] // Wasi does not support threads
    fn test_spawn_many_from_block_on() {
        use tokio::sync::mpsc;
        ...
        println!("\t{}/test_spawn_many_from_block_on PASS", module_path!());
    }

    #[cfg(not(target_os="wasi"))] // Wasi does not support threads
    fn test_spawn_many_from_task() {
        use tokio::sync::mpsc;
        ...
        println!("\t{}/test_spawn_many_from_task PASS", module_path!());
    }

    fn test_spawn_one_from_block_on_called_on_handle() {
        let rt = rt();
        let (tx, rx) = oneshot::channel();
        ...
        assert_eq!(out, "ZOMG");
        println!("\t{}/test_spawn_one_from_block_on_called_on_handle PASS", module_path!());
    }
    ...
    fn test_spawn_await_chain() {
        ...
        assert_eq!(out, "hello");
        println!("\t{}/test_spawn_await_chain PASS", module_path!());
    }

    fn test_outstanding_tasks_dropped() {
        let rt = rt();
        ...
        println!("\t{}/test_outstanding_tasks_dropped PASS", module_path!());
    }

    fn test_create_rt_in_block_on() {
        let rt1 = rt();
        let rt2 = rt1.block_on(async { rt() });
        let out = rt2.block_on(async { "ZOMG" });

        assert_eq!(out, "ZOMG");
        println!("\t{}/test_create_rt_in_block_on PASS", module_path!());
    }

    #[cfg(not(target_os="wasi"))] // Wasi does not support threads
    fn test_complete_block_on_under_load() {
        let rt = rt();
        ...
        println!("\t{}/test_complete_block_on_under_load PASS", module_path!());
    }

    #[cfg(not(target_os="wasi"))] // Wasi does not support threads
    fn test_complete_task_under_load() {
        let rt = rt();
        ...
        println!("\t{}/test_complete_task_under_load PASS", module_path!());
    }

    #[cfg(not(target_os="wasi"))] // Wasi does not support threads
    fn test_spawn_from_other_thread_idle() {
        let rt = rt();
        let handle = rt.clone();
        ...
        println!("\t{}/test_spawn_from_other_thread_idle PASS", module_path!());
    }

    #[cfg(not(target_os="wasi"))] // Wasi does not support threads
    fn test_spawn_from_other_thread_under_load() {
        let rt = rt();
        let handle = rt.clone();
        ...
        println!("\t{}/test_spawn_from_other_thread_under_load PASS", module_path!());
    }

    fn test_sleep_at_root() {
        let rt = rt();
        ...
        println!("\t{}/test_sleep_at_root PASS", module_path!());
    }

    fn test_sleep_in_spawn() {
        let rt = rt();
        ...
        assert!(now.elapsed() >= dur);
        println!("\t{}/test_sleep_in_spawn PASS", module_path!());
    }

    #[cfg(not(target_os="wasi"))] // Wasi does not support bind
    #[cfg_attr(miri, ignore)] // No `socket` in miri.
    fn test_block_on_socket() {
        let rt = rt();
        ...
        println!("\t{}/test_block_on_socket PASS", module_path!());
    }
    ...
    fn test_spawn_from_blocking() {
        ...
        assert_eq!(out, "hello");
        println!("\t{}/test_spawn_from_blocking PASS", module_path!());
    }
    ...
    */
    ...
    pub fn run_all_tests() {
        ...
        test_spawn_one_join();
        test_spawn_two();
        test_spawn_many_from_block_on();
        test_spawn_many_from_task();
        test_spawn_one_from_block_on_called_on_handle();
        test_spawn_await_chain();
        test_outstanding_tasks_dropped();
        test_create_rt_in_block_on();
        test_complete_block_on_under_load();
        test_complete_task_under_load();
        test_spawn_from_other_thread_idle();
        test_spawn_from_other_thread_under_load();
        test_sleep_at_root();
        test_sleep_in_spawn();
