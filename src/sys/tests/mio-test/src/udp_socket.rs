...
fn test_assert_size() {
    ...
    println!("udp_socket::test_assert_size PASS");
}
...
fn test_empty_datagram() {
    ...
    println!("udp_socket::test_empty_datagram PASS");
}

fn test_is_send_and_sync() {
    assert_send::<UdpSocket>();
    assert_sync::<UdpSocket>();
    println!("udp_socket::test_is_send_and_sync PASS");
}

fn test_unconnected_udp_socket_ipv4() {
    ...
    println!("udp_socket::test_unconnected_udp_socket_ipv4 PASS");
}

fn test_unconnected_udp_socket_ipv6() {
    let socket1 = UdpSocket::bind(any_local_ipv6_address()).unwrap();
    let socket2 = UdpSocket::bind(any_local_ipv6_address()).unwrap();
    smoke_test_unconnected_udp_socket(socket1, socket2);
    println!("udp_socket::test_unconnected_udp_socket_ipv6 PASS");
}

fn test_unconnected_udp_socket_std() {
    ...
    smoke_test_unconnected_udp_socket(socket1, socket2);
    println!("udp_socket::test_unconnected_udp_socket_std PASS");
}
