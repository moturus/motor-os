...
```
$ rustup default nightly-2024-05-30
$ rustup component add rust-src --toolchain nightly-2024-05-30-x86_64-unknown-linux-gnu
...
```
$ cd $MOTORH
$ git clone -b moturus-2024-05-30 https://github.com/moturus/rust.git
```
