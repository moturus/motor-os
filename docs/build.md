...
```
$ rustup default nightly-2024-06-14
$ rustup component add rust-src --toolchain nightly-2024-06-14-x86_64-unknown-linux-gnu
...
```
$ cd $MOTORH
$ git clone -b motor-os_2024-06-15 https://github.com/moturus/rust.git
```
